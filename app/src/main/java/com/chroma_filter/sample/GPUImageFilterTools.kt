...
object GPUImageFilterTools {
    ...
    fun createFilterForChroma(context: Context, resourceID: Int): GPUImageFilter {
        return createChromaFilter(
            context,
            GPUImageChromaKeyBlendFilter::class.java, resourceID
        )
    }


    fun createChromaFilter(
        context: Context,
